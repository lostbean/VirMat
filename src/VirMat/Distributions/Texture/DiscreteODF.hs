...
distributeWeightedOrientations :: Vector (Euler,Double) -> Double
                               -> ((Double,Int),(Double,Int),(Double,Int))-> DiscODF
distributeWeightedOrientations os step ((sPHI1,nPHI1),(sPHI,nPHI),(sPHI2,nPHI2)) = let
...
distributeOrientations os step ((sPHI1,nPHI1),(sPHI,nPHI),(sPHI2,nPHI2)) = let
  one = 1
  linSize = if nPHI1*nPHI*nPHI2 > 0
            then nPHI1*nPHI*nPHI2
            else error "Can,t create discrete ODF. Number of bins null or negative."
